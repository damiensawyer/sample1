...
public class SingleSportDepthChartTests
{
  ...
  public void AddPlayer_ShouldAddPlayers(IDepthChartService _depthChart)
  {
    // Arrange
  ...
  [Theory]
  [MemberData(nameof(DepthChartServices.GetDepthChartServices), MemberType = typeof(DepthChartServices))]
  public void RemovingAllPlayersFromGivenPositionRemovesPositionFromDepthChart(IDepthChartService _depthChart)
  {
    // Arrange
    _depthChart.AddPlayerToDepthChart(this._bob, "WR", 0);
    _depthChart.AddPlayerToDepthChart(this._alice, "WR", 1);
  ...
  [Theory]
  [MemberData(nameof(DepthChartServices.GetDepthChartServices), MemberType = typeof(DepthChartServices))]
  public void AllowCaseInsensitiveLookupOnPosition(IDepthChartService depthChart)
  {
    // Arrange
  ...
  [Theory]
  [MemberData(nameof(DepthChartServices.GetDepthChartServices), MemberType = typeof(DepthChartServices))]
  public void KeyValuePairFormatting(IDepthChartService _depthChart)
  {
    // Arrange
    _depthChart.AddPlayerToDepthChart(this._bob, "WR", 0);
    _depthChart.AddPlayerToDepthChart(this._alice, "WR", 1);
  ...
  [Theory]
  [MemberData(nameof(DepthChartServices.GetDepthChartServices), MemberType = typeof(DepthChartServices))]
  public void AddPlayer_Twice_ShouldMoveThem(IDepthChartService _depthChart)
  {
    // Arrange
  ...
  [Theory]
  [MemberData(nameof(DepthChartServices.GetDepthChartServices), MemberType = typeof(DepthChartServices))]
  public void Adding_Bad_Position_ShouldThrowException(IDepthChartService _depthChart) =>
    Assert.Throws<ArgumentException>(() => _depthChart.AddPlayerToDepthChart(this._bob, "bad", 0));

  [Theory]
  [MemberData(nameof(DepthChartServices.GetDepthChartServices), MemberType = typeof(DepthChartServices))]
  public void AddPlayer_ToEndOfChart_ShouldAppend(IDepthChartService _depthChart)
  {
    // Arrange
  ...
  [Theory]
  [MemberData(nameof(DepthChartServices.GetDepthChartServices), MemberType = typeof(DepthChartServices))]
  public void AddPlayer_ToMultiplePositions_ShouldWork(IDepthChartService _depthChart)
  {
    // Arrange
    _depthChart.AddPlayerToDepthChart(this._bob, "WR");
  ...
  [Theory]
  [MemberData(nameof(DepthChartServices.GetDepthChartServices), MemberType = typeof(DepthChartServices))]
  public void AddPlayer_TwiceToSamePosition_ShouldUpdatePosition(IDepthChartService _depthChart)
  {
    // Arrange
    _depthChart.AddPlayerToDepthChart(this._bob, "WR", 0);
    _depthChart.AddPlayerToDepthChart(this._alice, "WR", 1);
  ...
  [Theory]
  [MemberData(nameof(DepthChartServices.GetDepthChartServices), MemberType = typeof(DepthChartServices))]
  public void RemovePlayer_ShouldRemoveCorrectly(IDepthChartService _depthChart)
  {
    // Arrange
    _depthChart.AddPlayerToDepthChart(this._bob, "WR", 0);
    _depthChart.AddPlayerToDepthChart(this._alice, "WR", 1);
  ...
  [Theory]
  [MemberData(nameof(DepthChartServices.GetDepthChartServices), MemberType = typeof(DepthChartServices))]
  public void MultiplePlayerRemovalIsIdempotent(IDepthChartService _depthChart)
  {
    // Arrange
    _depthChart.AddPlayerToDepthChart(this._bob, "WR", 0);
    _depthChart.RemovePlayerFromDepthChart(this._bob, "WR");
  ...
  [Theory]
  [MemberData(nameof(DepthChartServices.GetDepthChartServices), MemberType = typeof(DepthChartServices))]
  public void Removal_OfNonExistingPlayer_ShouldNotThrowException(IDepthChartService _depthChart) =>
    _depthChart.RemovePlayerFromDepthChart(this._bob, "WR");

  [Theory]
  [MemberData(nameof(DepthChartServices.GetDepthChartServices), MemberType = typeof(DepthChartServices))]
  public void GetPlayersUnderPlayer_ShouldReturnCorrectPlayers(IDepthChartService _depthChart)
  {
    // Arrange
    _depthChart.AddPlayerToDepthChart(this._bob, "WR", 0);
  ...
  [Theory]
  [MemberData(nameof(DepthChartServices.GetDepthChartServices), MemberType = typeof(DepthChartServices))]
  public void GetPlayersUnderPlayer_LastPlayer_ShouldReturnEmpty(IDepthChartService _depthChart)
  {
    // Arrange
    _depthChart.AddPlayerToDepthChart(this._bob, "WR", 0);
    _depthChart.AddPlayerToDepthChart(this._alice, "WR", 1);
  ...
  [Theory]
  [MemberData(nameof(DepthChartServices.GetDepthChartServices), MemberType = typeof(DepthChartServices))]
  public void GetPlayersUnderPlayer_PlayerNotInChart_ShouldReturnEmpty(IDepthChartService _depthChart)
  {
    // Arrange
  ...
  [Theory]
  [MemberData(nameof(DepthChartServices.GetDepthChartServices), MemberType = typeof(DepthChartServices))]
  public void AddPlayer_ShouldPushMultiplePlayersDown(IDepthChartService _depthChart)
  {
    // Arrange
  ...
  [Theory]
  [MemberData(nameof(DepthChartServices.GetDepthChartServices), MemberType = typeof(DepthChartServices))]
  public void AddPlayer_ShouldPushDownCorrespondingPlayers(IDepthChartService _depthChart)
  {
    // Arrange
  ...
  [Theory]
  [MemberData(nameof(DepthChartServices.GetDepthChartServices), MemberType = typeof(DepthChartServices))]
  public void GetFullDepthChart_EmptyDepthChart_ShouldReturnEmptyDictionary(IDepthChartService _depthChart)
  {
    // Arrange
  ...
  [Theory]
  [MemberData(nameof(DepthChartServices.GetDepthChartServices), MemberType = typeof(DepthChartServices))]
  public void AddPlayer_ShouldPutOutlyingPositionsToBottom(IDepthChartService _depthChart)
  {
    // Arrange
    _depthChart.AddPlayerToDepthChart(this._charlie, "WR", 0); // Charlie is starter
    _depthChart.AddPlayerToDepthChart(this._david, "WR", 1); // David is backup
  ...
  [Theory]
  [MemberData(nameof(DepthChartServices.GetDepthChartServices), MemberType = typeof(DepthChartServices))]
  public void AddPlayer_ShouldPushExistingPlayerDown(IDepthChartService _depthChart)
  {
    // Arrange
    _depthChart.AddPlayerToDepthChart(this._bob, "WR", 0);
    _depthChart.AddPlayerToDepthChart(this._alice, "WR", 0);
  ...
  [Theory]
  [MemberData(nameof(DepthChartServices.GetDepthChartServices), MemberType = typeof(DepthChartServices))]
  public void AddPlayer_LargeDepthChart_ShouldPerformEfficiently(IDepthChartService _depthChart)
  {
    // Arrange
